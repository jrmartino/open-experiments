...
public class CreateSakaiUserServlet2 extends AbstractUserPostServlet {
  ...
  private static final Logger log = LoggerFactory
      .getLogger(CreateSakaiUserServlet2.class);
  ...
  protected void handleOperation(SlingHttpServletRequest request, HtmlResponse response,
    ...
    try {
      ...
      response
          .setParentLocation(AuthorizableResourceProvider.SYSTEM_USER_MANAGER_USER_PATH);
